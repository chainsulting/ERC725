...
Smart contract based accounts following this standard have the following advantages:
...
Executes a call on any other smart contract, transfers the blockchains native token, or deploys a new smart contract.
